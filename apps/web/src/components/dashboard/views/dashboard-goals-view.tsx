...
export function DashboardGoalsView({
  ...
  return (
    <div className="space-y-6 2xl:space-y-8">
      <DashboardPageHeader
        title="Metas"
        description="Organize seus objetivos e acompanhe o quanto falta para chegar lá."
      />
      ...
      >
        <div className="rounded-[1.25rem] border border-border/60 bg-card/70 px-4 py-3 shadow-sm">
