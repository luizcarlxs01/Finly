...
namespace Finly.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260921032154_AddPasswordReset")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finly.Domain.Entities.EmailVerificationCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Finly.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Finly.Domain.Entities.Topic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Finly.Domain.Entities.TopicReply", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TopicReplies", (string)null);
                });
            ...
            modelBuilder.Entity("Finly.Domain.Entities.Topic", b =>
                {
                    b.HasOne("Finly.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("Finly.Domain.Entities.TopicReply", b =>
                {
                    b.HasOne("Finly.Domain.Entities.Topic", "Topic")
                        .WithMany("Replies")
